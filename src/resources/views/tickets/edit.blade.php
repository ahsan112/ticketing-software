    ...
    <x-container>
        ...
        @unless (is_null($ticket->accepted) || $ticket->rejected())            
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 sm:gap-6 sm:mt-24 mt-12">
                <div class="col-span-1 sm:col-span-2">
                    <div class="flex justify-between  items-center">
                        ...
                        <div>
                            @can('manage-task')
                                @unless ($ticket->completed())                                    
                                    <a href="{{ route('ticket.tasks.create', $ticket) }}" class="px-10 inline-flex items-center py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">Add</a>
                                @endunless
                            @endcan
                        </div>
                    </div>
                ...
                <div class="col-span-1">
                    <x-ticket-activity :activities="$ticket->activity" />
                </div>
            </div>
